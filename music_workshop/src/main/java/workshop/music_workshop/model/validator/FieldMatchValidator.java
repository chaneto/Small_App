package workshop.music_workshop.model.validator;
...
public class FieldMatchValidator implements ConstraintValidator<FieldMatch, Object> {
    ...
    public boolean isValid(Object value, ConstraintValidatorContext context) {
        ...
        if(!valid){
            context
                    .buildConstraintViolationWithTemplate(message).addPropertyNode(firstField)
                    .addConstraintViolation()
                    .buildConstraintViolationWithTemplate(message).addPropertyNode(secondField)
